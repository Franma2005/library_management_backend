...
public class LibraryUserGroupMapper {
	...
	public static List<LibraryUser> libraryUserReciveGrouptoLibraryUserGroup(
			List<LibraryUserRecive> libraryUserReciveGroup) {
		...
		for (LibraryUserRecive libraryUserRecive : libraryUserReciveGroup) {
			libraryUserGroup.add(LibraryUserMapper.libraryUserRecivetoLibraryUser(libraryUserRecive));
		}

		return libraryUserGroup;
	}

	public static List<LibraryUser> libraryUserEntityGrouptoLibraryUserGroup(
			List<LibraryUserEntity> libraryUserEntityGroup) {
		List<LibraryUser> libraryUserGroup = new ArrayList<LibraryUser>();

		for (LibraryUserEntity libraryUserEntity : libraryUserEntityGroup) {
			libraryUserGroup.add(LibraryUserMapper.libraryUserEntitytoLibraryUser(libraryUserEntity));
		}
	...
	public static List<LibraryUserDto> libraryUserGrouptoLibraryUserDtoGroup(List<LibraryUser> libraryUserGroup) {
		...
		for (LibraryUser libraryUser : libraryUserGroup) {
			libraryUserDtoGroup.add(LibraryUserMapper.libraryUsertoLibraryUserDto(libraryUser));
		}
